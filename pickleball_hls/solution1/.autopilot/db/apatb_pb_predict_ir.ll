; ModuleID = 'C:/Users/NCF/Downloads/CG4002/ultra96_env/hls_src/pickleball_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_pb_predict_ir(%"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(12) %input_stream, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(12) %output_stream) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"* nonnull %input_stream, i32* %input_stream_copy.data, i4* %input_stream_copy.keep, i4* %input_stream_copy.strb, i1* %input_stream_copy.last, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"* nonnull %output_stream, i32* %output_stream_copy.data, i4* %output_stream_copy.keep, i4* %output_stream_copy.strb, i1* %output_stream_copy.last)
  call void @apatb_pb_predict_hw(i32* %input_stream_copy.data, i4* %input_stream_copy.keep, i4* %input_stream_copy.strb, i1* %input_stream_copy.last, i32* %output_stream_copy.data, i4* %output_stream_copy.keep, i4* %output_stream_copy.strb, i1* %output_stream_copy.last)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"* %input_stream, i32* %input_stream_copy.data, i4* %input_stream_copy.keep, i4* %input_stream_copy.strb, i1* %input_stream_copy.last, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"* %output_stream, i32* %output_stream_copy.data, i4* %output_stream_copy.keep, i4* %output_stream_copy.strb, i1* %output_stream_copy.last)
  ret void
}
...
declare void @apatb_pb_predict_hw(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*)
...
define void @pb_predict_hw_stub_wrapper(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*) #5 {
entry:
  ...
  call void @pb_predict_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"* %8, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"* %9)
...
declare void @pb_predict_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"*, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0>, 0>"*)
