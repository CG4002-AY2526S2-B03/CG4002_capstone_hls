set moduleName pb_predict_Pipeline_WRITE_REG
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pb_predict_Pipeline_WRITE_REG}
set C_modelType { void 0 }
set C_modelArgList {
	{ reg_out float 32 regular  }
	{ reg_out_1 float 32 regular  }
	{ reg_out_2 float 32 regular  }
	{ reg_out_3 float 32 regular  }
	{ reg_out_4 float 32 regular  }
	{ reg_out_5 float 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "reg_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "reg_out_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "reg_out_2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "reg_out_3", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "reg_out_4", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "reg_out_5", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ reg_out sc_in sc_lv 32 signal 0 } 
	{ reg_out_1 sc_in sc_lv 32 signal 1 } 
	{ reg_out_2 sc_in sc_lv 32 signal 2 } 
	{ reg_out_3 sc_in sc_lv 32 signal 3 } 
	{ reg_out_4 sc_in sc_lv 32 signal 4 } 
	{ reg_out_5 sc_in sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "reg_out", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "reg_out", "role": "default" }} , 
 	{ "name": "reg_out_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "reg_out_1", "role": "default" }} , 
 	{ "name": "reg_out_2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "reg_out_2", "role": "default" }} , 
 	{ "name": "reg_out_3", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "reg_out_3", "role": "default" }} , 
 	{ "name": "reg_out_4", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "reg_out_4", "role": "default" }} , 
 	{ "name": "reg_out_5", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "reg_out_5", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_63_32_1_1_U389", "Parent" : "0"},
...
set Spec2ImplPortList { 
	reg_out { ap_none {  { reg_out in_data 0 32 } } }
	reg_out_1 { ap_none {  { reg_out_1 in_data 0 32 } } }
	reg_out_2 { ap_none {  { reg_out_2 in_data 0 32 } } }
	reg_out_3 { ap_none {  { reg_out_3 in_data 0 32 } } }
	reg_out_4 { ap_none {  { reg_out_4 in_data 0 32 } } }
	reg_out_5 { ap_none {  { reg_out_5 in_data 0 32 } } }
