...
// wrapc file define:
#define AUTOTB_TVIN_input_stream_V_data_V "../tv/cdatafile/c.pb_predict.autotvin_input_stream_V_data_V.dat"
#define AUTOTB_TVOUT_input_stream_V_data_V "../tv/cdatafile/c.pb_predict.autotvout_input_stream_V_data_V.dat"
#define AUTOTB_TVIN_input_stream_V_keep_V "../tv/cdatafile/c.pb_predict.autotvin_input_stream_V_keep_V.dat"
#define AUTOTB_TVOUT_input_stream_V_keep_V "../tv/cdatafile/c.pb_predict.autotvout_input_stream_V_keep_V.dat"
#define AUTOTB_TVIN_input_stream_V_strb_V "../tv/cdatafile/c.pb_predict.autotvin_input_stream_V_strb_V.dat"
#define AUTOTB_TVOUT_input_stream_V_strb_V "../tv/cdatafile/c.pb_predict.autotvout_input_stream_V_strb_V.dat"
#define AUTOTB_TVIN_input_stream_V_last_V "../tv/cdatafile/c.pb_predict.autotvin_input_stream_V_last_V.dat"
#define AUTOTB_TVOUT_input_stream_V_last_V "../tv/cdatafile/c.pb_predict.autotvout_input_stream_V_last_V.dat"
...
#define AUTOTB_TVIN_output_stream_V_data_V "../tv/cdatafile/c.pb_predict.autotvin_output_stream_V_data_V.dat"
#define AUTOTB_TVOUT_output_stream_V_data_V "../tv/cdatafile/c.pb_predict.autotvout_output_stream_V_data_V.dat"
#define AUTOTB_TVIN_output_stream_V_keep_V "../tv/cdatafile/c.pb_predict.autotvin_output_stream_V_keep_V.dat"
#define AUTOTB_TVOUT_output_stream_V_keep_V "../tv/cdatafile/c.pb_predict.autotvout_output_stream_V_keep_V.dat"
#define AUTOTB_TVIN_output_stream_V_strb_V "../tv/cdatafile/c.pb_predict.autotvin_output_stream_V_strb_V.dat"
#define AUTOTB_TVOUT_output_stream_V_strb_V "../tv/cdatafile/c.pb_predict.autotvout_output_stream_V_strb_V.dat"
#define AUTOTB_TVIN_output_stream_V_last_V "../tv/cdatafile/c.pb_predict.autotvin_output_stream_V_last_V.dat"
#define AUTOTB_TVOUT_output_stream_V_last_V "../tv/cdatafile/c.pb_predict.autotvout_output_stream_V_last_V.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_input_stream_V_data_V "../tv/rtldatafile/rtl.pb_predict.autotvout_input_stream_V_data_V.dat"
#define AUTOTB_TVOUT_PC_input_stream_V_keep_V "../tv/rtldatafile/rtl.pb_predict.autotvout_input_stream_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_input_stream_V_strb_V "../tv/rtldatafile/rtl.pb_predict.autotvout_input_stream_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_input_stream_V_last_V "../tv/rtldatafile/rtl.pb_predict.autotvout_input_stream_V_last_V.dat"
#define AUTOTB_TVOUT_PC_output_stream_V_data_V "../tv/rtldatafile/rtl.pb_predict.autotvout_output_stream_V_data_V.dat"
#define AUTOTB_TVOUT_PC_output_stream_V_keep_V "../tv/rtldatafile/rtl.pb_predict.autotvout_output_stream_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_output_stream_V_strb_V "../tv/rtldatafile/rtl.pb_predict.autotvout_output_stream_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_output_stream_V_last_V "../tv/rtldatafile/rtl.pb_predict.autotvout_output_stream_V_last_V.dat"
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "output_stream" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
...
((int*)&xlx_stream_elt_data)[0] = output_stream_V_data_V_pc_buffer_Copy[j].to_int64();
((hls::stream<int>*)__xlx_apatb_param_output_stream_V_data_V)->write(xlx_stream_elt_data);
char xlx_stream_elt_keep;
((char*)&xlx_stream_elt_keep)[0] = output_stream_V_keep_V_pc_buffer_Copy[j].to_int64();
((hls::stream<char>*)__xlx_apatb_param_output_stream_V_keep_V)->write(xlx_stream_elt_keep);
char xlx_stream_elt_strb;
((char*)&xlx_stream_elt_strb)[0] = output_stream_V_strb_V_pc_buffer_Copy[j].to_int64();
((hls::stream<char>*)__xlx_apatb_param_output_stream_V_strb_V)->write(xlx_stream_elt_strb);
char xlx_stream_elt_last;
((char*)&xlx_stream_elt_last)[0] = output_stream_V_last_V_pc_buffer_Copy[j].to_uint64();
((hls::stream<char>*)__xlx_apatb_param_output_stream_V_last_V)->write(xlx_stream_elt_last);
}}
...
// dest
// data
std::vector<int> __xlx_apatb_param_output_stream_V_data_V_stream_buf;
long __xlx_apatb_param_output_stream_stream_buf_size = ((hls::stream<int>*)__xlx_apatb_param_output_stream_V_data_V)->size();
// keep
std::vector<char> __xlx_apatb_param_output_stream_V_keep_V_stream_buf;
// strb
std::vector<char> __xlx_apatb_param_output_stream_V_strb_V_stream_buf;
// user
// last
std::vector<char> __xlx_apatb_param_output_stream_V_last_V_stream_buf;
// id
// dest
CodeState = CALL_C_DUT;
pb_predict_hw_stub_wrapper(__xlx_apatb_param_input_stream_V_data_V, __xlx_apatb_param_input_stream_V_keep_V, __xlx_apatb_param_input_stream_V_strb_V, __xlx_apatb_param_input_stream_V_last_V, __xlx_apatb_param_output_stream_V_data_V, __xlx_apatb_param_output_stream_V_keep_V, __xlx_apatb_param_output_stream_V_strb_V, __xlx_apatb_param_output_stream_V_last_V);
...
long __xlx_apatb_param_output_stream_stream_buf_final_size = ((hls::stream<int>*)__xlx_apatb_param_output_stream_V_data_V)->size() - __xlx_apatb_param_output_stream_stream_buf_size;
{
  while (!((hls::stream<int>*)__xlx_apatb_param_output_stream_V_data_V)->empty())
    __xlx_apatb_param_output_stream_V_data_V_stream_buf.push_back(((hls::stream<int>*)__xlx_apatb_param_output_stream_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_output_stream_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<int>*)__xlx_apatb_param_output_stream_V_data_V)->write(__xlx_apatb_param_output_stream_V_data_V_stream_buf[i]);
  }
{
  while (!((hls::stream<char>*)__xlx_apatb_param_output_stream_V_keep_V)->empty())
    __xlx_apatb_param_output_stream_V_keep_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_output_stream_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_output_stream_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_output_stream_V_keep_V)->write(__xlx_apatb_param_output_stream_V_keep_V_stream_buf[i]);
  }
{
  while (!((hls::stream<char>*)__xlx_apatb_param_output_stream_V_strb_V)->empty())
    __xlx_apatb_param_output_stream_V_strb_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_output_stream_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_output_stream_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_output_stream_V_strb_V)->write(__xlx_apatb_param_output_stream_V_strb_V_stream_buf[i]);
  }
{
  while (!((hls::stream<char>*)__xlx_apatb_param_output_stream_V_last_V)->empty())
    __xlx_apatb_param_output_stream_V_last_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_output_stream_V_last_V)->read());
  for (int i = 0; i < __xlx_apatb_param_output_stream_V_last_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_output_stream_V_last_V)->write(__xlx_apatb_param_output_stream_V_last_V_stream_buf[i]);
  }
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_last_V, begin_str(AESL_transaction));
for (int i = 0; i < __xlx_apatb_param_output_stream_stream_buf_final_size; ++i) {
  std::string s;
s = formatData((unsigned char*)(__xlx_apatb_param_output_stream_V_data_V_stream_buf.data()+__xlx_apatb_param_output_stream_stream_buf_size+i), 32);
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_data_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_output_stream_V_keep_V_stream_buf.data()+__xlx_apatb_param_output_stream_stream_buf_size+i), 4);
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_keep_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_output_stream_V_strb_V_stream_buf.data()+__xlx_apatb_param_output_stream_stream_buf_size+i), 4);
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_strb_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_output_stream_V_last_V_stream_buf.data()+__xlx_apatb_param_output_stream_stream_buf_size+i), 1);
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_last_V, s);
}
tcl_file.set_num(__xlx_apatb_param_output_stream_stream_buf_final_size, &tcl_file.output_stream_V_data_V_depth);
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_data_V, end_str());
tcl_file.set_num(__xlx_apatb_param_output_stream_stream_buf_final_size, &tcl_file.output_stream_V_keep_V_depth);
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_keep_V, end_str());
tcl_file.set_num(__xlx_apatb_param_output_stream_stream_buf_final_size, &tcl_file.output_stream_V_strb_V_depth);
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_strb_V, end_str());
tcl_file.set_num(__xlx_apatb_param_output_stream_stream_buf_final_size, &tcl_file.output_stream_V_last_V_depth);
aesl_fh.write(AUTOTB_TVOUT_output_stream_V_last_V, end_str());
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_data_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_output_stream_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_output_stream_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_output_stream_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_output_stream_V_last_V, end_str());
}
