...
unsigned int ap_apatb__cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_out_.dat");
extern "C" void pb_predict(volatile void *, volatile void *, volatile void *, , volatile void *, , , volatile void *, volatile void *, volatile void *, , volatile void *, , );
...
auto* soutput_stream_V_data_V = bcsim::createStream((hls::stream<int>*)__xlx_apatb_param_output_stream_V_data_V);
...
auto* soutput_stream_V_keep_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_keep_V);
...
auto* soutput_stream_V_strb_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_strb_V);
...
auto* soutput_stream_V_last_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_last_V);
  // DUT call
  pb_predict(sinput_stream_V_data_V->data<int>(), sinput_stream_V_keep_V->data<char>(), sinput_stream_V_strb_V->data<char>(), sinput_stream_V_last_V->data<char>(), soutput_stream_V_data_V->data<int>(), soutput_stream_V_keep_V->data<char>(), soutput_stream_V_strb_V->data<char>(), soutput_stream_V_last_V->data<char>());
