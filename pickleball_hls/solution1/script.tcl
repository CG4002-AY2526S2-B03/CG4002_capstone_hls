...
config_export -description {PickleballNet MTL MLP - 3x512 ReLU6 BN-fused} -display_name PickleballNet -format ip_catalog -rtl verilog -vendor cg4002 -version 3.0 -vivado_clock 10
